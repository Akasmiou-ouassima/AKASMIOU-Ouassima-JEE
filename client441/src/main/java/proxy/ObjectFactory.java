...
public class ObjectFactory {
    ...
    private static final QName _Convert_QNAME = new QName("http://ws.sid.org/", "Convert");
    private static final QName _ConvertResponse_QNAME = new QName("http://ws.sid.org/", "ConvertResponse");
    private static final QName _GetCompte_QNAME = new QName("http://ws.sid.org/", "getCompte");
    private static final QName _GetCompteResponse_QNAME = new QName("http://ws.sid.org/", "getCompteResponse");
    private static final QName _ListComptes_QNAME = new QName("http://ws.sid.org/", "listComptes");
    private static final QName _ListComptesResponse_QNAME = new QName("http://ws.sid.org/", "listComptesResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://ws.sid.org/", name = "Convert")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.sid.org/", name = "ConvertResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.sid.org/", name = "listComptes")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.sid.org/", name = "listComptesResponse")
